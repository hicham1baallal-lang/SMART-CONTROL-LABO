    ...
    if 'data_granulats' not in st.session_state:
        st.session_state['data_granulats'] = {
            ...
            'SC': {
                ...
                'refus': [0.1, 40.1, 40.1, 50.1, 60.2, 70.2, 80.2, 90.3, 10.0, 8.0, 7.0, 6.0, 5.0, 4.0, 3.0, 2.0, 1.0, 1.0, 1.0, 1.0, 9.1],
            ...
            'SD': {
                ...
                'refus': [0.1, 10.1, 10.2, 2.0, 3.0, 4.0, 8.0, 1.00, 1.50, 2.00, 1.50, 1.00, 1.02],
